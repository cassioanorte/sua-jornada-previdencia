...
Quer entender se seu caso de negativa tem caminho de reversão? Chama no WhatsApp. Link na bio. (54) 99987-0786`,
  "pericia-medica-inss-negada-o-que-fazer": `## A cena que acontece todo dia no Brasil

João esperou três semanas pela perícia. No dia, passou menos de dez minutos com o médico perito. Ouviu que estava "apto para o trabalho" e foi embora sem entender nada — com a coluna ainda doendo e uma carta de negativa na mão.

Isso acontece todos os dias. E a maioria das pessoas acredita que a história acabou aí. Não acabou.

## Por que as perícias negam tanto?

O médico perito do INSS avalia a incapacidade laboral com base em critérios técnicos — mas também opera dentro de uma pressão institucional real. A perícia dura poucos minutos. O perito não acompanhou seu tratamento, não leu necessariamente todos os laudos que você trouxe.

Avaliações pontuais podem subestimar condições crônicas, flutuantes ou que não aparecem claramente em exame físico — como dores neuropáticas, transtornos mentais e fibromialgia.

## O que você pode fazer imediatamente

Assim que receber a negativa, guarde tudo: a carta do INSS com o número do benefício, a data da perícia e qualquer protocolo gerado.

Você tem 30 dias corridos a partir da ciência da decisão para entrar com recurso administrativo junto à Junta de Recursos do INSS, conforme o art. 305 e seguintes do Decreto 3.048/99. Esse prazo é improrrogável.

## O recurso administrativo: como funciona

O recurso é protocolado no próprio sistema Meu INSS, na opção "Recursos e Contestações". No recurso, você vai contestar a conclusão pericial apresentando novos documentos médicos, relatórios complementares, exames mais recentes, ou uma carta do seu médico explicando especificamente por que você está incapaz de exercer suas atividades habituais.

O ideal é que o médico que te acompanha escreva um documento direcionado: não apenas descrevendo a doença, mas explicando como ela impede o exercício da sua função específica.

## Quando o recurso administrativo não resolve

Se a Junta de Recursos mantiver a negativa, ainda há o recurso ao Conselho de Recursos do Seguro Social (CRSS). E se mesmo assim a negativa for mantida, o caminho é a via judicial.

A ação judicial previdenciária tramita, em regra, no Juizado Especial Federal (JEF). No Rio Grande do Sul, os JEFs têm histórico de reversão de negativas do INSS em casos devidamente documentados. Na via judicial, o juiz pode determinar uma perícia judicial — feita por um médico independente do INSS.

Quer saber se sua negativa tem fundamento para recurso? Chama no WhatsApp. Link na bio. (54) 99987-0786`,
...
Agende uma consulta gratuita e descubra como podemos ajudar a maximizar sua aposentadoria.
    `,
  "diferenca-aposentadoria-tempo-idade": `
...
Agende uma consulta gratuita e descubra qual é a melhor opção para o seu caso.
    `,
  "auxilio-acidente-inss-quem-tem-direito": `
...
Conte rapidamente: você é empregada registrada, contribuinte individual, trabalhadora rural ou adotante? Informe também a data prevista do parto ou da adoção, e nós orientaremos os próximos passos e documentos prioritários para solicitar o auxílio-maternidade.
    `,
  "documentos-auxilio-acidente-checklist": `
...
Auxílio-acidente e DPVAT são recursos importantes para quem sofreu um acidente e ficou com sequelas ou despesas médicas. A principal chave para o sucesso é a **organização**: junte laudos médicos claros, comprovantes de gastos e provas do acidente. Agende perícia no INSS sem demora e peça o DPVAT assim que possível. Se houver negativa, não desista — recorra administrativamente e, se necessário, procure assessoria especializada.
    `,
  "plano-de-reabilitacao-profissional": `
## Introdução
...
**#PensãoPorMorte #BenefícioINSS #DireitoPrevidenciário #QuemTemDireito #PensãoPorMorteINSS #DependentesINSS #BenefícioPrevidenciário #AdvogadoPrevidenciário #DireitosDosDepententes #INSS #PensãoMorte #SeguroSocial #UnidoEstável #ReformaDaPrevidência #SpierAnorte**`,
  "conferir-cnis-antes-de-solicitar-aposentadoria": `
...
**#AposentadoriaPorIdade #INSS #DireitoPrevidenciário #AposentadoriaIdade #BenefícioINSS #AdvogadoPrevidenciário #SpierAnorte**`,
  "consultar-profissional-antes-pedir-beneficio-previdenciario": `
## Introdução
...
- [Portal INSS](https://www.inss.gov.br) — informações oficiais e normativos
`,
  "aposentadoria-operador-maquinas-pesadas": `
...
`,
  "aposentadoria-dentista-contribuinte-individual": `
...
`,
  "reconhecimento-atividade-especial-dentista": `
...
- [Portal INSS](https://www.inss.gov.br) — informações oficiais
`,
  "atividade-especial-medico-contribuinte-individual": `
...
`,
  "doencas-que-geram-direito-aposentadoria-pcd": `
...
- [Portal INSS](https://www.gov.br/inss) — informações oficiais
`,
  "periculosidade-motoboy-entra-em-vigor-hoje": `
...
`,
  "atividade-de-risco-motoboy-beneficio-inss-sequelas-permanentes": `
...
`,
  "fim-da-renovacao-de-laudo-medico-para-autistas": `
...
`,
  "beneficios-por-incapacidade-no-inss": `
## Introdução
...
`,
  "aposentadoria-por-invalidez-como-pedir": `## Introdução
...
**Hashtags:** #AposentadoriaPorInvalidez #INSS #BenefíciosPorIncapacidade`,
  "pericia-medica-inss-como-preparar": `## Introdução
...
**Hashtags:** #PeríciaINSS #AuxílioDoença #DireitoPrevidenciário`,
  "bpc-vs-beneficios-inss": `## Introdução
...
**Hashtags:** #ReabilitaçãoProfissional #INSS #RetornoAoTrabalho`,
  ...
  "trf4-amplia-tempo-rural-mantem-atividade-especial": `## A decisão que pode mudar sua aposentadoria
...
- Documentos em nome dos pais ou irmãos podem ser aproveitados
- Declarações de sindicatos rurais têm peso probatório
- O INSS tem o dever de analisar o conjunto da documentação, não apenas documentos individuais
- A ausência de início de prova material em nome próprio não impede o reconhecimento quando há outros elementos do grupo familiar
...
- Exposição a ruído de 86 dB(A), aferido por dosimetria
- Exposição a inflamáveis (periculosidade)
...
- Reconhecimento do trabalho rural de **01/10/1982 a 31/12/1985** (mais de 3 anos adicionais)
- Manutenção dos períodos de atividade especial (com conversão pelo fator 1,40)
...
Tem dúvidas sobre tempo rural, atividade especial ou quer revisar sua aposentadoria? [Fale com um especialista agora](https://wa.me/5554999870786).
...
Quer saber se o seu acidente gerou sequela que dá direito ao auxílio-acidente? Chama no WhatsApp. Link na bio. (54) 99987-0786`,
  "tipos-de-acidente-que-dao-auxilio-acidente": `## O trabalhador que não sabia que tinha direito

Silvia caiu da escada em casa. Fraturou o tornozelo, ficou 3 meses afastada pelo auxílio-doença, e voltou ao trabalho com limitação de movimentos. O médico disse que era sequela permanente. Quando alguém perguntou se ela tinha pedido o auxílio-acidente, ela respondeu: "Mas não foi acidente de trabalho, foi em casa."

O que Silvia não sabia é que a Lei 8.213/91 não exige que seja acidente de trabalho.

## A base legal: o que diz o art. 86

O art. 86 da Lei 8.213/91 estabelece que o auxílio-acidente é devido ao segurado que, após consolidação das lesões decorrentes de acidente de qualquer natureza, resultar sequela permanente. A expressão "acidente de qualquer natureza" é o que abre o leque.

## Tipo 1: Acidente de trabalho típico

É o acidente que ocorre durante o exercício do trabalho, a serviço da empresa. O registro é feito pela empresa através da CAT (Comunicação de Acidente de Trabalho), o que facilita a comprovação.

Atenção: a falta de CAT não impede o direito ao benefício. A Súmula 229 do STJ reconhece que outras provas podem suprir.

## Tipo 2: Acidente de trajeto

O acidente que ocorre no percurso entre a residência e o trabalho também é equiparado ao acidente de trabalho para fins previdenciários, conforme o art. 21-A da Lei 8.213/91.

Isso inclui acidentes de carro, moto, ônibus, bicicleta ou a pé, desde que no trajeto habitual.

## Tipo 3: Acidente de qualquer natureza (não relacionado ao trabalho)

Aqui está o tipo mais ignorado. A Lei 8.213/91 é clara: o auxílio-acidente pode decorrer de acidente de qualquer natureza — não apenas os relacionados ao trabalho.

Isso significa: acidente doméstico, acidente de trânsito fora do trajeto trabalho-casa, acidente durante atividade de lazer, acidente esportivo — desde que resulte em sequela permanente redutora da capacidade laboral.

A condição é que o segurado seja empregado, trabalhador avulso ou segurado especial. O contribuinte individual não tem direito.

Quer verificar se o acidente que você sofreu se enquadra? Chama no WhatsApp. Link na bio. (54) 99987-0786`,
};
